...
export default function Profile() {
  ...
  return (
    <section className="w-screen h-screen bg-white relative flex items-center justify-center">
      <div className="bg-[#5bc8a8] w-full h-[30vh] absolute top-0"></div>

      <div className="w-[90%] h-[80vh] z-0 pt-[5rem] flex gap-[2rem] p-4">
        {/* Sidebar */}

        <div className="h-[40vh] w-[30%] py-4 flex flex-col gap-[1rem] items-center bg-white rounded-[5px] shadow">
          <img
        ...
        <div className="bg-white w-[70%] h-full rounded-[5px] shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] flex flex-col">
          ...
          {/* Tabs Content */}
          <div className="border-b-2 border-[#eef0f0] w-full py-8 px-8">
            {activeTab === "tab1" && (
              <div className="grid grid-cols-2 gap-8 h-auto">
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <input
                    disabled
                    className="bg-[#fbfdff] rounded-[5px] uppercase py-2 px-4 border-[1px] border-[#ddd] outline-none select-none"
                ...
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <input
                    disabled
                    className="bg-[#fbfdff] rounded-[5px] py-2 px-4 border-[1px] border-[#ddd] outline-none select-none"
